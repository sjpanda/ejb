...
public class Main {
	public static void main(String[] args) {
		try {
			...
			GestionContactRemote beanRemote = (GestionContactRemote)context.lookup("ContactBean");
			System.out.println(beanRemote.coucouContact("Mon Premier Client EJB3"));

			GestionContactRemote beanRemote2 = (GestionContactRemote)context.lookup("ContactBeanEntity");
